...
class TestUpgradeChromedriver:
                ...
                def test_upgrade(self):
                    ...
                    if major_chromedriver_ver != major_chrome_ver:
                        subprocess.check_call(
                            "pysel get chromedriver %s" % major_chrome_ver,
                            shell=True
                        )
            """
        )
    ...
    def test_upgrade_chromedriver(self, testdir):
        ...
        subprocess.check_call("pythonselenium get chromedriver", shell=True)
        ...
        try:
            ...
            install_command = "pythonselenium get chromedriver 72.0.3626.69"
