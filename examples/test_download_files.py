"""Use PythonSelenium to download files and verify."""
...
class DownloadTests(BaseCase):
    ...
    def test_download_files_from_pypi(self):
        ...
        if self.browser == "safari" or self.browser == "ie" or self.browser == "edge" or (self.is_chromium() and self.guest_mode) or (self.is_chromium() and (self.headless or self.headless2)):
