...
class App:
    ...
    def run_1(self):
        subprocess.Popen("pytest examples/my_first_test.py", shell=True)

    def run_2(self):
        subprocess.Popen("pytest examples/my_first_test.py --firefox", shell=True)

    def run_3(self):
        subprocess.Popen("pytest examples/my_first_test.py --demo_mode", shell=True)

    def run_4(self):
        subprocess.Popen("pytest examples/parameterized_test.py --rs", shell=True)

    def run_5(self):
        subprocess.Popen("pytest examples/test_fail.py --html=report.html", shell=True)

    def run_6(self):
        subprocess.Popen("pytest examples/test_suite.py --rs --dashboard", shell=True)

    def run_7(self):
        subprocess.Popen("pytest examples/test_deferred_asserts.py", shell=True)
