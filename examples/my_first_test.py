...
#    Default timeouts are configured in pythonselenium/config/settings.py
#
# 3. PythonSelenium methods often perform multiple actions.
...
#    * PythonSelenium/pythonselenium/fixtures/base_case.py
#
