...
class MyTourClass(BaseCase):
    def test_google_tour(self):
        ...
        self.add_tour_step("Welcome to Google Maps", title="PythonSelenium Tour")
        self.add_tour_step("The location goes here.", "#searchboxinput", title="Search Box")
        self.add_tour_step(
        ...
        self.add_tour_step("Thanks for using PythonSelenium Tours!", title="End of Guided Tour")
