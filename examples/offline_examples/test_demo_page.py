...
class OfflineTests(BaseCase):
    def test_demo_page(self):
        ...
        frame1 = self.get_element("#myFrame1")
        ...
        frame2 = self.get_element("#myFrame2")
        self.switch_to_frame(frame2)
        ...
        frame3 = self.get_element("#myFrame3")
        ...
        self.assert_link_text("wikipedia.org")
        self.assert_link_text("Wikipedia site")
