...
class HackTests(BaseCase):
    def test_all_your_base_are_belong_to_us(self):
        ...
        self.add_css_style(zoom_in)
        zoom_in = '[value="ALL YOUR BASE"]{zoom: 1.3;-moz-transform: scale(1.3);}' '[value="ARE BELONG TO US"]{zoom: 1.3;-moz-transform: scale(1.3);}'
        self.add_css_style(zoom_in)
        self.hide_elements("iframe")
        if self.is_element_visible('a[href*="about.google"]'):
        ...
        self.set_text_content(".profile-preview-card button", "PythonSelenium")
        ...
        self.add_css_style(zoom_in)
        self.set_text_content("h1", aybabtu)
        self.set_text_content("a.wp-element-button", "Use PythonSelenium!")
        ...
        self.set_text_content('div[class*="desktop"] a[href*="jira/pricing"]', ayb)
        self.set_text_content('div[class*="desktop"] a[href*="jira/enterprise"]', abtu)
        self.set_text_content('div[class*="desktop"] a[href="/software/jira/features"]', "")
        self.set_text_content("h1", aybabtu)
        self.highlight('div[class*="desktop"] a[href*="jira/pricing"]', loops=5, scroll=False)
        self.highlight('div[class*="desktop"] a[href*="jira/enterprise"]', loops=6, scroll=False)
        self.highlight("h1", loops=8, scroll=False)
