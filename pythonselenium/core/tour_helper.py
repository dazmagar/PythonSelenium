...
def activate_driverjs(driver):
    """Allows you to use DriverJS Tours with PythonSelenium
...
def activate_hopscotch(driver):
    """Allows you to use Hopscotch Tours with PythonSelenium
...
def activate_introjs(driver):
    """Allows you to use IntroJS Tours with PythonSelenium
    https://introjs.com/
    """
    intro_css = constants.IntroJS.MIN_CSS
    intro_js = constants.IntroJS.MIN_JS

    theme_color = ps_config.introjs_theme_color
    hover_color = ps_config.introjs_hover_color
...
def activate_shepherd(driver):
    """Allows you to use Shepherd Tours with PythonSelenium
