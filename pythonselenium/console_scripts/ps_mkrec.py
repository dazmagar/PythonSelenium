...
Creates a new PythonSelenium test file using the Recorder.

Usage:
      pythonselenium mkrec [FILE.py] [OPTIONS]
               pysel mkrec [FILE.py] [OPTIONS]
     pythonselenium record [FILE.py] [OPTIONS]
              pysel record [FILE.py] [OPTIONS]
    pythonselenium codegen [FILE.py] [OPTIONS]
...
def invalid_run_command(msg=None):
    ...
    exp += "  Usage:\n"
    exp += "           pythonselenium mkrec [FILE.py]\n"
    exp += "           OR:    pysel mkrec [FILE.py]\n"
    exp += "  Examples:\n"
    exp += "           pysel mkrec new_test.py\n"
    exp += "           pysel mkrec new_test.py --url=wikipedia.org\n"
    exp += "  Options:\n"
    ...
    exp += "  Output:\n"
    exp += "           Creates a new PythonSelenium test using the Recorder.\n"
...
def main():
    ...
    if esc_end:
        ...
        d2 = []
        d2.append("from pythonselenium import BaseCase")
        d2.append("")
        d2.append("")
        ...
        d2.append('            esc = "return document.ps_esc_end;"')
    ...
    if " " not in recorded_file:
        os.system("%spythonselenium print %s -n" % (prefix, recorded_file))
