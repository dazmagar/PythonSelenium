...
Usage:
        pythonselenium print [FILE] [OPTIONS]
          OR:    pysel print [FILE] [OPTIONS]
Options:
...
def invalid_run_command(msg=None):
    exp = "  ** print **\n\n"
    exp += "  Usage:\n"
    exp += "         pythonselenium print [FILE] [OPTIONS]\n"
    exp += "           OR:    pysel print [FILE] [OPTIONS]\n"
    exp += "  Options:\n"
...
def main():
    ...
    from pythonselenium.console_scripts import rich_helper
            ...
            if console_width:
                ...
                if line_length + w > console_width:  # 5 is line number ws
                    ...
                    if line.startswith("from") and " import " in line:
                        ...
                        new_ps_lines.append(line1)
                        new_ps_lines.append(line2)
                        continue
                    if (
                        line.count("(") >= 1
                        ...
                        if ("):") not in line2:
                            ...
                            if get_width(line2) + w > console_width:
                                if line2.count('", "') == 1:
                                    ...
                                    new_ps_lines.append(line2a)
                                    new_ps_lines.append(line2b)
                                    continue
                                elif line2.count("', '") == 1:
                                    line2a = line2.split("', '")[0] + "',"
                                    line2b = (
                    ...
                    if (
                        ...
                        if get_width(line1) + w <= console_width and (
                            ...
                            if (
                                ...
                                new_ps_lines.append(line2 + comments)
                            else:
                                new_ps_lines.append(line2)
                            continue
