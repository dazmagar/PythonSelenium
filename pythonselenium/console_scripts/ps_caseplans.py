...
Usage:
      pythonselenium caseplans [OPTIONAL PATH or TEST FILE]
...
if sys.version_info <= (3, 7):
    ...
    raise Exception("\n* PySel Case Plans Generator requires Python 3.7 or newer!" "\n** You are currently using Python %s" % current_version)
...
def create_tkinter_gui(tests, command_string):
    root = tk.Tk()
    root.title("pythonselenium Case Plans Generator")
...
if __name__ == "__main__":
    print('To open the Case Plans Generator, type "pysel caseplans"')
