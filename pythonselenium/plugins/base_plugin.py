"""Base Plugin for PythonSelenium tests that run with pynose / nosetests"""
import ast
import sys
import time
...
from pythonselenium.core import download_helper
from pythonselenium.core import log_helper
from pythonselenium.core import report_helper
    ...
    def options(self, parser, env):
        ...
        parser.addoption(
            ...
            help="""The file that stores key/value pairs for overriding
                    values in the PythonSelenium settings.py file.""",
        )
        parser.addoption(
            "--final-debug",
            "--final-trace",
