"""DB Reporting Plugin for PythonSelenium tests that use pynose / nosetests"""
import time
import uuid
...
class DBReporting(Plugin):
    ...
    def configure(self, options, conf):
        from pythonselenium.core.testcase_manager import TestcaseManager
    ...
    def begin(self):
        ...
        import getpass
        from pythonselenium.core.testcase_manager import ExecutionQueryPayload
    ...
    def handleError(self, test, err, capt=None):
        ...
        from pythonselenium.fixtures import errors
