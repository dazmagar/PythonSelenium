...
## PythonSelenium Methods (API Reference)

Here's a list of PythonSelenium method definitions, which are defined in **[base_case.py](/pythonselenium/fixtures/base_case.py)**
...
# "driver"-specific methods added (or modified) by PythonSelenium
...
# "driver"-specific methods added (or modified) by PythonSelenium for UC Mode:
...
✅ Test Folder: [PythonSelenium/examples](/examples)

* [my_first_test.py](/examples/my_first_test.py)
* [test_coffee_cart.py](/examples/test_coffee_cart.py)
* [parameterized_test.py](/examples/parameterized_test.py)
* [test_deferred_asserts.py](/examples/test_deferred_asserts.py)
* [test_markers.py](/examples/test_markers.py)
* [test_swag_labs.py](/examples/test_swag_labs.py)
* [test_suite.py](/examples/test_suite.py)
* And many more...
